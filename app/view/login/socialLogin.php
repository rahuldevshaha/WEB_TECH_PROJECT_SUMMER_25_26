...
<html>
    ...
    <body >
        ...
        <div id="social_login_page">
            ...
            <div class="social_login_right_section">
                ...
                <div class="login_card">
                    ...
                    <h2>Log in to your account in Mess Manager App</h2>

                    <div class="redirect_btn"> <button>Redirect</button></div>
                    ...
                    <a href="emailLogin.php" class="login_mail_btn">Login with Email</a>
