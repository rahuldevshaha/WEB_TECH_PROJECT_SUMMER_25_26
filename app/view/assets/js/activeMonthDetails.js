document.addEventListener("DOMContentLoaded", function () {
  ...
  window.openMealEditModal = function (
    mealRecordId,
    userId,
    mealDate,
    morning,
    ...
    document.getElementById("editMealMorning").checked = false;
    document.getElementById("editMealLunch").checked = false;
    document.getElementById("editMealDinner").checked = false;

    document.getElementById("editMealRecordId").value = mealRecordId || "";
    document.getElementById("editMealUserId").value = userId || "";
  ...
  window.openDepositEditModal = function (
    fundId,
    submittedBy,
    amount,
    note,
  ...
  window.openCostEditModal = function (
    expenseId,
    costType,
    costBy,
    amount,
