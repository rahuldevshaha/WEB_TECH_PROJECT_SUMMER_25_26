...
$sqlQ = "SELECT u.userId, u.Name, m.Role
         FROM Member m
...
if (reqMethodCheck("POST") && isset($_POST["add_cost_submit"])) {
    ...
    if (!$isErr) {
        ...
        $sqlQ = "INSERT INTO Expenses
                 (expenseId, messId, amount, note, costType, costDate, costBy, assignById)
                 VALUES
        ...
        if ($result) {
            ...
            if ($autoFund) {
                ...
                $sqlQ2 = "INSERT INTO Funds
                          (fundId, messId, amount, note, submitDate, submittedBy, receivedById)
                          VALUES
